...
import 'package:lpkni/app/modules/Merchant/ForgotPassword/controllers/StatusPasswordMerchant_controller.dart';

class StatuspasswordmerchantView
    extends GetView<StatuspasswordmerchantController> {
  const StatuspasswordmerchantView({super.key});
