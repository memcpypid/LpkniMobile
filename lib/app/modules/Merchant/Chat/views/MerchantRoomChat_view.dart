...
import 'package:lpkni/app/data/Merchant/Model/chatList_model.dart';
import 'package:lpkni/app/data/Merchant/Model/chat_model.dart';
import 'package:lpkni/app/modules/Merchant/Chat/controllers/MerchantChat_controller.dart';

class MerchantroomchatView extends StatelessWidget {
  final MerchantchatController chatController =
      Get.find<MerchantchatController>();
  ...
  MerchantroomchatView({required this.chatUser}); // 🔥 Tambahkan konstruktor
  @override
