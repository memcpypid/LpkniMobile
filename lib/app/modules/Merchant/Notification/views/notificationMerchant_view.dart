...
class NotificationmerchantView extends StatelessWidget {
  final NotificationmerchantController notificationController =
      Get.find<NotificationmerchantController>();
